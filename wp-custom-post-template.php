<?php
/*
Plugin Name: WP Post Template Forked
	...
	if ( is_array( $templates ) ) {
		...
		foreach ( $templates as $template ) {
			...
			if ( $basename != 'functions.php' ) {
				...
				$name = '';
				if ( preg_match( '|WP Post Template:(.*)$|mi', $template_data, $name ) && preg_match( '|WP Post Type:\s+(' . get_current_screen()->post_type . ')$|mi', $template_data, $matches ) ) {
